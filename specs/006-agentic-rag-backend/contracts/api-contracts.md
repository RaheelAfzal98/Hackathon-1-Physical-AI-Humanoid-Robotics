...
## Overview
This document defines the API contracts for the agent-based RAG backend system. The system provides endpoints for interacting with an AI agent that can answer questions grounded in the humanoid robotics textbook content.
